        ...
        <footer className={styles.footer}>
            <section className={styles.section}>
                <article className={styles.social}>
                    <figure>
                        <a target={"_blank"} rel={"noopener noreferrer"}  href={"https://www.facebook.com/people/EFFCA-Entente-Fons-Fourmagnac-Camburat-Assier/61571935581391/?_rdr"}>
                        <svg role="img" viewBox="0 0 24 24" fill={"white"} width={40} height={40} xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure>
                        <a target={"_blank"} rel={"noopener noreferrer"} href={"https://www.instagram.com/effca_foot/"}>
                        <svg width={40} height={40} role="img" viewBox="0 0 24 24" fill={"white"} xmlns="http://www.w3.org/2000/svg">
